            ...
            <div class="row py-5">
                <div class="col-lg-8">
                    ...
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item me-3 mb-1 mb-sm-0"><i class="fas fa-signal text-success me-2"></i>متوسطه
                        </li>
                        <li class="list-inline-item me-3 mb-1 mb-sm-0"><i
                            ...
                            <div class="tab-content pt-2" id="course-pills-tabContent">
                                ...
                                <div class="tab-pane fade show active" id="course-pills-1" role="tabpanel"
                                    ...
                                    <p class="mb-3">اگر می‌خواهید مهارت‌هایی را که باید در برنامه درسی دوره بازاریابی
                                        ...
                                        شما کمک خواهد کرد. قبل از اینکه به موارد پیشرفته بپردازیم <strong><a href="#"
                                                                                                             class="text-reset text-decoration-underline">دوره
                                    ...
                                    <ul class="list-group list-group-borderless mb-3">
                                        ...
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                                class="fas fa-check-circle text-success me-2"></i>آموزش فوتومونتاژ
                                        </li>
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                        ...
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                                class="fas fa-check-circle text-success me-2"></i>آموزش اجرای لوگو
                                        </li>
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                                class="fas fa-check-circle text-success me-2"></i>ساختار URL
                                        </li>
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                                class="fas fa-check-circle text-success me-2"></i>طراحی بنر های دیجیتالی
                                        </li>
                                        <li class="list-group-item h6 fw-light d-flex mb-0"><i
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">معرفی دوره</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px"> دیجیتال مارکتینگ چیست؟</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">انواع دیجیتال مارکتینگ</span>
                                                        </div>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">توضیح صفحات مختلف فتوشاپ</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">توضیح تخصصی ابزار ها(قسمت اول)</span>
                                                        </div>
                                                        <p class="mb-0">11ساعت</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <div class="row g-sm-0 align-items-center">
                                                                <div class="col-sm-6">
                                                                    <span
                                                                        class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-md-400px">توضیح تخصصی ابزار ها(قسمت دوم)</span>
                                                                </div>
                                                                <div class="col-sm-6">
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">مروری بر سئو</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ادیت تصویر مخصوص آتلیه</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">شروع طراحی سایت دیجی کالا</span>
                                                        </div>
                                                        <p class="mb-0">15دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ساخت کارت ویزیت</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">برنامه ریزی کلمات کلیدی SEO</span>
                                                        </div>
                                                        <p class="mb-0">18دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">سئوی تجارت الکترونیک</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">لینک های داخلی و خارجی</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">سئوی موبایل</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">آپدیت دوره فتوشاپ</span>
                                                        </div>
                                                        <p class="mb-0">18دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">نصب فتوشاپ 2021</span>
                                                        </div>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ایجاد صفحات فیس بوک</span>
                                                        </div>
                                                        <p class="mb-0 text-truncate">25دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">المان های گرافیکی</span>
                                                        </div>
                                                        <p class="mb-0">11ساعت</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">Paint Eyedropper</span>
                                                        </div>
                                                        <p class="mb-0">25دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ابزار Webmaster</span>
                                                        </div>
                                                        <p class="mb-0 text-truncate">15دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">انتشار مطالب ویژه در YouTube</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <div class="row g-sm-0 align-items-center">
                                                                <div class="col-sm-6">
                                                                    <span
                                                                        class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-md-400px">توضیح تخصصی ابزار ها(قسمت اول)</span>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <span class="badge text-bg-orange ms-2 ms-md-0"><i
                                                                            class="fas fa-lock fa-fw me-1"></i>پولی</span>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">روش ساخت پروژه جدید</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">توضیح تخصصی ابزار ها(قسمت دوم)</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <div class="row g-sm-0 align-items-center">
                                                                <div class="col-sm-6">
                                                                    <span
                                                                        class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-md-400px">توضیح تخصصی ابزار ها(قسمت آخر)</span>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <span class="badge text-bg-orange ms-2 ms-md-0"><i
                                                                            class="fas fa-lock fa-fw me-1"></i>پولی</span>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <div class="row g-sm-0 align-items-center">
                                                                <div class="col-sm-6">
                                                                    <span
                                                                        class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-md-400px">برنامه ریزی کلمات کلیدی بهینه سازی</span>
                                                                </div>
                                                                <div class="col-sm-6">
                                                                    <span class="badge text-bg-orange ms-2 ms-md-0"><i
                                                                            class="fas fa-lock fa-fw me-1"></i>پولی</span>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ساخت منوها در بخش مدیریت</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">استفاده از قالب استاندارد وردپرس در پلاگین ها</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px"> مفهوم آرایه و ذخیره‌سازی آن در حافظه</span>
                                                        </div>
                                                        <p class="mb-0">12دقیقه</p>
                                                    </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px"> مرتبه‌های اجرایی و نمادها</span>
                                                        </div>
                                                        <p class="mb-0 text-truncate">7ساعت</p>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="accordion-body mt-3">
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">ساخت اکانت لینکدین</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">جستجوی پیشرفته</span>
                                                        </div>
                                                    ...
                                                    <div class="d-flex justify-content-between align-items-center">
                                                        <div class="position-relative d-flex align-items-center">
                                                            ...
                                                            <span
                                                                class="d-inline-block text-truncate ms-2 mb-0 h6 fw-light w-100px w-sm-200px w-md-400px">اپلیکیشن موبایل لینکدین</span>
                                                        </div>
                                                        <p class="mb-0 text-truncate">25دقیقه</p>
                                                    </div>
                                                </div>
