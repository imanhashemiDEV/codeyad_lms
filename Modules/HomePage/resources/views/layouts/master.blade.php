                                ...
                                <div class="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
                                    <div class="row p-4">
                                        ...
                                        <div class="col-xl-6 col-xxl-4 mb-4 mb-xl-0">
                                            ...
                                            <!-- Dropdown item -->
                                            <div class="d-flex mb-4 position-relative">
                                                <img src="{{url('assets/images/client/uni-logo-02.svg')}}" class="icon-md" alt="">
                                                <div class="ms-3">
                                            ...
                                            <!-- Dropdown item -->
                                            <div class="d-flex mb-4 position-relative">
                                                <img src="{{url('assets/images/client/uni-logo-03.svg')}}" class="icon-md" alt="">
                                                <div class="ms-3">
                                            ...
                                            <!-- Dropdown item -->
                                            <div class="d-flex mb-4 position-relative">
                                                <img src="{{url('assets/images/client/uni-logo-01.svg')}}" class="icon-md" alt="">
                                                <div class="ms-3">
                                                    <a class="stretched-link h6 mb-0 fw-normal" href="#">مدرک بین المللی زبـان</a>
                                                    <p class="mb-0 small">لیسانس کامپیوتر</p>
                                                </div>
                ...
                <div class="col-xl-7 order-2 order-xl-1">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center" style="background:url({{url('assets/images/pattern/02.png')}}) no-repeat center center; background-size:cover;">
                                <!-- Info -->
