    ...
    <div>
        ...
        <div class="row">
            ...
            <div class="d-sm-flex justify-content-sm-between align-items-center mb-3">
                ...
                <a href="#" class="btn btn-sm btn-primary-soft mb-0" data-bs-toggle="modal" data-bs-target="#addLecture"><i class="bi bi-plus-circle me-2"></i>افزودن فصل</a>
            </div>
                ...
                <div class="modal-body">
                    <form class="row text-start g-3">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" class="form-control" placeholder="نام فصل را وارد کنید">
                        </div>
                    </form>
                </div>
